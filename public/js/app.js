...
__webpack_require__(/*! alpinejs */ "./node_modules/alpinejs/dist/alpine.js"); // header__menu__burger
...
var infoButtons = document.querySelectorAll('.informations__button');
var infoContent = document.querySelectorAll('.informations__content');

if (infoButtons && infoContent) {
  var _loop = function _loop(i) {
    infoButtons[i].addEventListener('click', function () {
      // tous les button    
      var _iterator = _createForOfIteratorHelper(infoButtons),
          _step;
      ...
      var _iterator2 = _createForOfIteratorHelper(infoContent),
          _step2;
